  PFont fuente;
  PImage presentacion,fonal,pistola; 
  int Px=500;
  int X,Y;
  ...
  if(Px<-625){
    background(0);}//pantalla 5
    if(Px<-700){
      text("unit production manager \n JEFREY HAYES",75,240);
    }
  if(Px<-775){
    background(0);}//pantalla final
    if(Px<-850){
